...
public class SecurityConfig {
    ...
    @Bean
    @Order(2)
    public SecurityFilterChain authenticationConfig(HttpSecurity http)  {
        http.formLogin(Customizer.withDefaults());
        http.csrf(AbstractHttpConfigurer::disable);
        http.authorizeHttpRequests(authorizeRequests -> authorizeRequests.requestMatchers("/api/v1/clients","/api/v1/users","/api/v1/authorities","/api/v1/roles","/login/**","/error/**").permitAll()
